function createHtml(obj) {
    ...
    htmstr.push(  "<tr> <td class=\"tdt tdl tdr\" style=\" vertical-align:middle;\">图片预览：</td> <td class=\"tdt tdl tdr\" colspan=\"2\"><div style=\"text-align:center;\"><img src=\"../img/2.png\"/></div></td> </tr>");
    htmstr.push(  "</table>")
    htmstr.push(  "</form>");
